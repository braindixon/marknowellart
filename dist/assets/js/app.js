...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation(); // DESKTOP NAVIGATION

jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("scroll", function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).scrollTop() > 600) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#links").addClass("shrink");
  }

  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).scrollTop() > 600) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#links").addClass("shrink");
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#links").removeClass("shrink");
  }
});
...
module.exports = __webpack_require__(/*! /Users/bdixon/SITES/marknowellart/src/assets/js/app.js */"./src/assets/js/app.js");
